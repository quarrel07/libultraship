...
class Interpreter {
  public:
    ...
    bool ImportTextureRgba16(int tile, bool importReplacement);
    bool ImportTextureRgba32(int tile, bool importReplacement);
    bool ImportTextureIA4(int tile, bool importReplacement);
    bool ImportTextureIA8(int tile, bool importReplacement);
    bool ImportTextureIA16(int tile, bool importReplacement);
    bool ImportTextureI4(int tile, bool importReplacement);
    bool ImportTextureI8(int tile, bool importReplacement);
    bool ImportTextureCi4(int tile, bool importReplacement);
    bool ImportTextureCi8(int tile, bool importReplacement);
    bool ImportTextureRaw(int tile, bool importReplacement);
    bool ImportTextureImg(int tile, bool importReplacement);
    void ImportTexture(int i, int tile, bool importReplacement);
    void TextureCacheEraseCurrent(int i);
