...
class Gui {
  public:
     ...
     * rasterization. 1.0 on standard-DPI displays, ~2.0 on typical Retina, fractional on scaled modes.
     * Set by the windowing backend before Init() (see Fast3dGui::Init); 1.0 if it could not be detected.
     */
